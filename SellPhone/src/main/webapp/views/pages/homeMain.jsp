...
<body>  
    <header>
        ...
        <div class="icons">
            <a href="AddToCartServlet?id"><i class="fas fa-shopping-cart fa-xl" style="color: #000000;"></i></a>
            <a href="#"><i class="fa-solid fa-circle-info fa-lg" style="color: #000000;"></i></a>
            <a href="/SellPhone/DisplayProductServlet"><i class="fas fa-user fa-xl" style="color: #000000;"></i></a>
        </div>
    </header>
